...
using Howbot.Infrastructure.Services.Concrete;
...
using DiscordGatewayIntents = Discord.GatewayIntents;
using DiscordLogSeverity = Discord.LogSeverity;

namespace Howbot.Infrastructure.Extensions;
...
public static class ServiceCollectionSetupExtensions
{
  ...
  public static void AddHowbotServices(this IServiceCollection services)
  {
    services.AddSingleton(_ => new DiscordSocketClient(new DiscordSocketConfig()
    {
      ...
      GatewayIntents = DiscordGatewayIntents.AllUnprivileged | DiscordGatewayIntents.GuildMembers,
      LogLevel = DiscordLogSeverity.Debug,
