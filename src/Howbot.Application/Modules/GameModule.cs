...
{
  [SlashCommand(CommandMetadata.RollCommandName, CommandMetadata.RollCommandDescription, true, RunMode.Async)]
  ...
  [SlashCommand(CommandMetadata.FlipCommandName, CommandMetadata.FlipCommandDescription, true, RunMode.Async)]
  [RequireContext(ContextType.Guild)]
  ...
  [SlashCommand(CommandMetadata.ActivitiesCommandName, CommandMetadata.ActivitiesCommandDescription, true,
    RunMode.Async)]
