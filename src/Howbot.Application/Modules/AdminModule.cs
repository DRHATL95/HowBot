...
{
  [SlashCommand(CommandMetadata.PurgeCommandName, CommandMetadata.PurgeCommandDescription, true, RunMode.Async)]
  ...
  public async Task PurgeCommandAsync()
  {
    ...
    try
    {
      ...
      var messages = (await Context.Channel.GetMessagesAsync(ValidationLimits.MaximumMessageCount).FlattenAsync()).ToList();
  ...
  [SlashCommand(CommandMetadata.BanCommandName, CommandMetadata.BanCommandDescription, true, RunMode.Async)]
  [RequireContext(ContextType.Guild)]
  ...
  [SlashCommand(CommandMetadata.UnbanCommandName, CommandMetadata.UnbanCommandDescription, true, RunMode.Async)]
  [RequireContext(ContextType.Guild)]
  [RequireUserPermission(GuildPermission.Administrator | GuildPermission.BanMembers |
                         GuildPermission.UseApplicationCommands)]
  [RequireBotPermission(GuildPermission.Administrator | GuildPermission.BanMembers)]
  ...
  [SlashCommand(CommandMetadata.CleanCommandName, CommandMetadata.CleanCommandDescription, true, RunMode.Async)]
  [RequireContext(ContextType.Guild)]
  ...
  [SlashCommand(CommandMetadata.MuteCommandName, CommandMetadata.MuteCommandDescription, true, RunMode.Async)]
  [RequireContext(ContextType.Guild)]
  ...
  [SlashCommand(CommandMetadata.UnmuteCommandName, CommandMetadata.UnmuteCommandDescription, true, RunMode.Async)]
  [RequireContext(ContextType.Guild)]
  [RequireUserPermission(GuildPermission.Administrator | GuildPermission.MuteMembers |
                         GuildPermission.UseApplicationCommands)]
  [RequireBotPermission(GuildPermission.Administrator | GuildPermission.MuteMembers)]
  ...
  [SlashCommand(CommandMetadata.KickCommandName, CommandMetadata.KickCommandDescription, true, RunMode.Async)]
  [RequireContext(ContextType.Guild)]
  ...
  [SlashCommand(CommandMetadata.SlowmodeCommandName, CommandMetadata.SlowmodeCommandDescription, true,
    RunMode.Async)]
  [RequireContext(ContextType.Guild)]
  ...
  [SlashCommand(CommandMetadata.LockCommandName, CommandMetadata.LockCommandDescription, true, RunMode.Async)]
  [RequireContext(ContextType.Guild)]
  [RequireUserPermission(GuildPermission.Administrator | GuildPermission.ManageChannels |
                         GuildPermission.UseApplicationCommands)]
  [RequireBotPermission(GuildPermission.Administrator | GuildPermission.ManageChannels)]
  ...
  [SlashCommand(CommandMetadata.UnlockCommandName, CommandMetadata.UnlockCommandDescription, true, RunMode.Async)]
  [RequireContext(ContextType.Guild)]
  [RequireUserPermission(GuildPermission.Administrator | GuildPermission.ManageChannels |
                         GuildPermission.UseApplicationCommands)]
  [RequireBotPermission(GuildPermission.Administrator | GuildPermission.ManageChannels)]
    ...
    IServiceProvider serviceProvider) : InteractionModuleBase<SocketInteractionContext>
  {
    ...
    public async Task PrefixCommandAsync(
      [Summary(CommandMetadata.SettingsPrefixArgumentName,
        CommandMetadata.SettingsPrefixArgumentDescription)]
      string newPrefix)
    {
      await DeferAsync();
    ...
    public async Task ProviderCommandAsync(
      [Summary(CommandMetadata.SettingsProviderArgumentName, CommandMetadata.SettingsProviderArgumentDescription)]
    ...
    [SlashCommand(CommandMetadata.VolumeCommandName, CommandMetadata.VolumeCommandDescription, false,
      RunMode.Async)]
    public async Task VolumeCommandAsync(
      [Summary(CommandMetadata.SettingsVolumeArgumentName, CommandMetadata.SettingsVolumeArgumentDescription)]
      int? volume = null)
    {
      await DeferAsync();
